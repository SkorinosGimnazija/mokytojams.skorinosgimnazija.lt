...
import { useDeleteClasstimeMutation, useListClasstimesQuery } from '@/services/generatedApi.ts'
import { recordsCountText } from '@/utils/constants.ts'
import { Table } from '@mantine/core'

export function ViewClasstimes() {
  const query = useListClasstimesQuery()
  const [deleteRecord] = useDeleteClasstimeMutation()
    ...
    <TableLayout topBar={<NewRecordButton/>}>
      <Table.Thead>
        <Table.Tr>
          ...
          <Table.Th w="35%">Laikas</Table.Th>
          <Table.Th w="35%">Sutrumpintas laikas</Table.Th>

...
import { useDeleteObservationOptionMutation, useListObservationOptionsQuery } from '@/services/generatedApi.ts'
import { recordsCountText } from '@/utils/constants.ts'
import { Table } from '@mantine/core'
import React from 'react'

export function ViewObservationOptions() {
  const query = useListObservationOptionsQuery()
  const [deleteRecord] = useDeleteObservationOptionMutation()
  ...
  return (
    <>
      <TableLayout topBar={<NewRecordButton/>}>
        <Table.Thead>
          <Table.Tr>
            <Table.Th>Pasirinkimas</Table.Th>

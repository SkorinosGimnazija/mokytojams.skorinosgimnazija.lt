...
export function UpdateObservationLesson() {
  ...
  const query = useGetObservationLessonQuery(id, { skip: !isEdit || form.initialized })
  const [createRecord] = useCreateObservationLessonMutation()
  const [updateRecord] = useUpdateObservationLessonMutation()
